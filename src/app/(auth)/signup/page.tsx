...
const Page = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Validation
    if (!formData.ad || !formData.soyad || !formData.email || !formData.kullanici_adi || !formData.sifre) {
        ...
        <form className="grid grid-cols-1 gap-6" onSubmit={handleSubmit}>
          <div className="grid grid-cols-2 gap-4">
            <Field className="block">
              <Label className="text-neutral-800 dark:text-neutral-200">Ad *</Label>
              <Input
                type="text"
                name="ad"
                value={formData.ad}
            ...
            <Field className="block">
              <Label className="text-neutral-800 dark:text-neutral-200">Soyad *</Label>
              <Input
                type="text"
                name="soyad"
          ...
          <Field className="block">
            <Label className="text-neutral-800 dark:text-neutral-200">E-posta *</Label>
            <Input
              type="email"
              name="email"
          ...
          <Field className="block">
            <Label className="text-neutral-800 dark:text-neutral-200">Kullanıcı Adı *</Label>
            <Input
              type="text"
              name="kullanici_adi"
          ...
          <Field className="block">
            <Label className="text-neutral-800 dark:text-neutral-200">Telefon</Label>
            <Input
              type="tel"
              name="telefon"
