export const en = {
  ...
  carPage: {
    title: 'Car - Home',
    heading: 'Find rides.',
    description: 'Discover of car rentals tailored to your needs.',
    startSearch: 'Start your search',
    exploreHeading: 'Find your perfect cars',
    exploreSubheading: 'Explore the best cars and experiences around the world',
    bestRentals: 'The best car rentals',
    bestRentalsSubheading: 'Discover great cars near where you live',
    viewAll: 'View all car rentals',
    carTypes: 'Explore by types of stays.',
    carTypesSubheading: 'Explore houses based on 10 types of stays',
  },
}
