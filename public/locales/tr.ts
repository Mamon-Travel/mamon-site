export const tr = {
  ...
  carPage: {
    title: 'Araç Kirala',
    heading: 'Sürüş keyfini yaşa.',
    description: 'İhtiyaçlarınıza göre özel araç kiralama seçeneklerini keşfedin.',
    startSearch: 'Aramaya başla',
    exploreHeading: 'Mükemmel aracınızı bulun',
    exploreSubheading: 'Dünyanın en iyi araçlarını ve deneyimlerini keşfedin',
    bestRentals: 'En iyi araç kiralamaları',
    bestRentalsSubheading: 'Yakınınızdaki harika araçları keşfedin',
    viewAll: 'Tüm Araçları Görüntüle',
    carTypes: 'Konaklama türlerine göre keşfedin.',
    carTypesSubheading: '10 farklı konaklama türüne göre keşfedin',
  },
}
